...
int main(int argc, char** argv) {
    ...
    //Declare Variables
    float score1,score2;                    //The scores for player 1 and 2
    ...
    while(score1<=10000&&score2<=10000){
            ...
            cout<<player1<<"'s score is"<<score1<<endl;
            ...
            cout<<player2<<"'s score is"<<score2<<endl;
        }   
    //Display Outputs
    if(score1>=10000){
        w1++;
    ...
    outputFile<<player1<<"'s score : "<<score1<<endl;
    outputFile<<player2<<"'s score : "<<score2<<endl;
