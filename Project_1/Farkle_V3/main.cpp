...
int main(int argc, char** argv) {
    ...
    while(fScore1<=10000&&fScore2<=10000){
            ...
            cout<<player1<<"'s score is "<<fScore1<<endl;
            ...
            cout<<player2<<"'s score is "<<fScore2<<endl;
        }   
    ...
    outputFile<<player1<<"'s score : "<<fScore1<<endl;
    outputFile<<player2<<"'s score : "<<fScore2<<endl;
