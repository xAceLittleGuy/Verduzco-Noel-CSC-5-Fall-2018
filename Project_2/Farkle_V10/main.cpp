...
int main(int argc, char** argv) {
    ...
    int ini1,ini2,                          //Initial roll to see who goes 1st
        ...
        value;                              //A random value to search for in the array
    ...
    while(fScore1<=10000&&fScore2<=10000){
        ...
        //Player 1 deciding how to score points
        
        //Decision to cash in 1s for points
        if(ones>0){
            do{
        ...
        //Decision to cash in 2s for points
        if(twos==3){
            do{
        ...
        //Decision to cash in 6s for points
        if(sixes==3){
            do{
        ...
        //Decision to cash in six-dice straight for points
        if(ones==6 || twos==6 || threes==6 || fours==6 || fives ==6 || sixes==6){
            do{
                cout<<"Would you like to cash in your six-dice straight for points?"<<endl;
                cout<<"Type in 'Y' for yes and 'N' for no."<<endl;
                cin>>dec;
                //Input Validation
                if(dec!='Y'&&dec!='N'){
                ...
                if(dec=='N'){
                    cout<<"You did not cash out your six-dice straight"<<endl;
                }
            }while(dec!='Y'&&dec!='N');
        }
    ...
    //Calculate and display the wins and losses
    winloss(fScore1,fScore2,w1,w2,los1,los2);
    
    //Save scores and win/losses count to text file
    scores(player1,player2,fScore1,fScore2,w1,w2,los1,los2);
    
    //Random linear search for a value
    cout<<"========================================="<<endl;
...
void winloss(int fS1, int fS2, int &w1, int &w2, int &los1, int &los2,
        int winCond){
    //Calculate and display the wins and losses
    if(fS1>=winCond){
        w1++;
